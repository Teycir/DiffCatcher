...
pub fn extract_from_patch(
    ...
    for file in parsed.files {
        ...
        let elements = if options.no_summary_extraction || file.is_binary {
            Vec::new()
        } else {
            let detected = detect_elements(&file.new_path, &file.hunks, options.max_elements);
            ...
            detected
                ...
                .map(|detected| {
                    ...
                    let in_test = is_test_path(&file.new_path);

...
- [x] 2026-03-01: Added project config support via `.diffcatcher.toml`, plugin loading for extra security patterns and extractor definitions, benchmark harness (`benches/core_bench.rs`), and GitHub Actions CI/release workflows.
